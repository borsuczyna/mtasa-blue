...
public:
    ...
    LUA_DECLARE(DxGetShaderDiagnostics);
    LUA_DECLARE(DxGetRenderStatistics);
    ...
    LUA_DECLARE(DxBeginRenderPass);
    LUA_DECLARE(DxEndRenderPass);
    LUA_DECLARE(DxUpdateScreenSource);
    LUA_DECLARE(DxGetStatus);
    LUA_DECLARE(DxGetRenderCapabilities);
